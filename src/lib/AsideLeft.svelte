<script>
 ...
 <!-- Left Sidebar -->
  <aside
    class=" w-1/6 py-10 pl-10  min-w-min  border-r border-gray-300 dark:border-zinc-700  hidden md:block hidden ">
    ...
    <div class=" font-bold text-lg flex items-center gap-x-3">
      ...
      <div class="tracking-wide dark:text-white">COMMFIX<span class="text-red-600">.</span></div>
    </div>
